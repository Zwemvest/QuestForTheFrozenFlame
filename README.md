...
![2021-11-22-22-49-26](questforthefrozenflame/2021-11-22-22-49-26.png)
- get the Obsidian/Roam style `[wikilinks](wikilinks)` from your vault in your published notes
...
![2021-11-22-22-54-02](questforthefrozenflame/2021-11-22-22-54-02.png)
...
![2021-11-22-22-52-49](questforthefrozenflame/2021-11-22-22-52-49.png)
...
- If you would like to arrange the pages manually, then use the `nav` option in the `mkdocs.yml` [](https://www.mkdocs.org/#adding-pages) at the root of this repo  to set custom page navigation.
